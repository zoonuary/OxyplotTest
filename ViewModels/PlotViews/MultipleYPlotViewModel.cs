...
{
    public class MultipleYPlotViewModel : ViewModelBase, INavigationAware
    {
        ...
        public MultipleYPlotViewModel(GraphCore graphCore)
        {
            GraphCore = graphCore;
        ...
        private void OnGraphCollectionChanged(object sender, EventArgs e)
        {
            ...
            {
                var yAxis = AxisCopy(graph.GraphRenderModel.YAxis);
